...
const md_to_adf_1 = __importDefault(__nccwpck_require__(708));
function convertToADF() {
    try {
        const markdown = core.getInput("md-text");
        const adfBody = (0, md_to_adf_1.default)(markdown);
        core.setOutput("adf-output", { body: adfBody });
    }
    catch (error) {
